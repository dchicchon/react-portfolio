...
class Portfolio extends Component {
    state = {
        ...
        projects: [
            ...
            { name: 'Zoo', tech: 'Heroku, MongoDB, Bootstrap, React.js', logo: zooLogo, photoAuthor: '', description: 'This app keeps track of animals in the MongoDB Zoo!', additionalInfo: '', siteLink: 'https://react-zoo.herokuapp.com/', repoLink: 'https://github.com/dchicchon/mongo-zoo' },
